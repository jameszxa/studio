    ...
    <div className="flex h-screen bg-white text-black">
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="flex-1 p-4 space-y-1">
          <Button
            variant="ghost"
            className="justify-start w-full font-normal rounded-md hover:bg-yellow-200"
          ...
          <Button
            variant="ghost"
            className="justify-start w-full font-normal rounded-md hover:bg-yellow-200"
            data-active={activeTab === 'shipment'}
          ...
          <Button
            variant="ghost"
            className="justify-start w-full font-normal rounded-md hover:bg-yellow-200"
            data-active={activeTab === 'storeSetting'}
            onClick={() => setActiveTab('storeSetting')}
          >
          ...
          <Button
            variant="ghost"
            className="justify-start w-full font-normal rounded-md hover:bg-yellow-200"
            data-active={activeTab === 'platformPartner'}
            onClick={() => setActiveTab('platformPartner')}
          >
            <Users className="mr-2 h-4 w-4"/>
            Platform Partner
          </Button>
          ...
          <Button
            variant="ghost"
            className="justify-start w-full font-normal rounded-md hover:bg-yellow-200"
            data-active={activeTab === 'helpSupport'}
      ...
      <div className="flex-1 p-4">
        ...
        {/* Render other tab contents here */}
      </div>
    </div>
  );
};
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          ...
          <div className="text-sm">
            JohnDoe123@gmail.com (account payable)
          </div>
          <div className="text-sm">
